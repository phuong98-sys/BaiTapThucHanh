...
{
    public abstract class TestAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TestAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TestAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TestAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TestAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TestAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TestAngularDbContext, Task<T>> func)
        {
            T result;
