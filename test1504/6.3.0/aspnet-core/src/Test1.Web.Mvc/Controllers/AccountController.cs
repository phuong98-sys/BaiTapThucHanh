...
using Test1.Sessions;
using Test1.Web.Models.Account;
using Test1.Web.Views.Shared.Components.TenantChange;

namespace Test1.Web.Controllers
{
    public class AccountController : Test1ControllerBase
    {
