...
namespace OutlookFW.Web.TokenStorage
{
    public class SessionTokenStore
    {
        ...
        public void SaveUserDetails(Sender user)
        {
        ...
        public Sender GetUserDetails()
        {
            sessionLock.EnterReadLock();
            var cachedUser = JsonConvert.DeserializeObject<Sender>((string)httpContext.Session[userCacheKey]);
            sessionLock.ExitReadLock();
            return cachedUser;
        }
