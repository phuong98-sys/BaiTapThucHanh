...
namespace Gosei.SimpleTaskApp.Migrations
{
    ...
    [Migration("20210426043142_InitialEmployee")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gosei.SimpleTaskApp.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Gosei.SimpleTaskApp.Persons.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Gosei.SimpleTaskApp.Tasks.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Gosei.SimpleTaskApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Gosei.SimpleTaskApp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Gosei.SimpleTaskApp.Tasks.Task", b =>
                {
                    b.HasOne("Gosei.SimpleTaskApp.Persons.Person", "AssignedPerson")
                        .WithMany()
