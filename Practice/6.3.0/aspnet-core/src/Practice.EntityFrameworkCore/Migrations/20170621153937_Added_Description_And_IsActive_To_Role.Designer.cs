...
namespace Practice.Migrations
{
    ...
    partial class Added_Description_And_IsActive_To_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Practice.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Practice.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Practice.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Practice.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Practice.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Practice.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
