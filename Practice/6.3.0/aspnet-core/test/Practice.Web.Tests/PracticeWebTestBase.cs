...
{
    public abstract class PracticeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PracticeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PracticeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PracticeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PracticeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PracticeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PracticeDbContext, Task<T>> func)
        {
            T result;
